...
class _WelcomeState extends State<Welcome> {
  ...
  Future<void> logoutUser(
    ...
    final response = await http.post(
      Uri.parse(
          'http://192.168.43.194:8000/logout/'), // Assure-toi que c'est l'URL correcte
    ...
    if (response.statusCode == 200) {
      await storage.deleteAll(); // Supprime toutes les données sécurisées
      Navigator.pushReplacementNamed(
          context, '/login'); // Redirige vers la page de connexion
    } else {
